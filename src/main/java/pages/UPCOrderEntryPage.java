...
public class UPCOrderEntryPage {
...
//		excel = new ExcelUtility(dataPropertyObject.getProperty("XPATH_FILE"), "HomePage");
	...
	//UPC Order Entry Tab
	public WebElement upcOrderEntryTab(WebDriver chrome_webDriver) {
//		String upcOrderEntryTab = excel.getData(2, 1).toString();
		element = chrome_webDriver.findElement(By.xpath("//*[@id='mnuMainMenu']/ul/li[2]/ul/li[9]/a"));
		
		return element;
	}
	//Market Watch
	public WebElement marketWatch(WebDriver chrome_webDriver){
		element = chrome_webDriver.findElement(By.xpath("//div[contains(@class,'panel-heading')]"));
		return element;
	}
	//Product Group
	public WebElement productGroup(WebDriver chrome_webDriver) {
		element = chrome_webDriver.findElement(By.xpath("//*[@id=\"s2id_ddlProductGroup\"]/a"));
		return element;
	}
	//Product
